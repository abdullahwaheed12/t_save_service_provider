                          ...
                          child: Padding(
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                Hero(
                                    tag:
                                        '${_homeLogic.currentShopData!.get('image')}',
                                    child: Material(
                                        child: InkWell(
                                      onTap: () {
                                ...
                                Expanded(
                                  ...
                                  children: [
                                    ...
                                    Text(
                                      '${_homeLogic.currentShopData!.get('email')}',
                                    ...
                                    Text(
                                      '${_homeLogic.currentShopData!.get('phone')}',
                                      style: state.detailTextStyle,
                                    ),
                                    Divider(
                                      color: Colors.black.withOpacity(0.5),
                                    ...
                                    Text(
                                      '${_homeLogic.currentShopData!.get('address')}',
                                      style: state.detailTextStyle,
                                    ),
                                  ],
                                ))
          ...
          child: InkWell(
            onTap: () {
              Get.to(EditProfilePage(
                shopModel: _homeLogic.currentShopData,
              ));
            },
            child: Container(
