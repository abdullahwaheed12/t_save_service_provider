...
class EditProfilePage extends StatefulWidget {
  const EditProfilePage({Key? key, this.shopModel}) : super(key: key);
...
class _EditProfilePageState extends State<EditProfilePage> {
  ...
  void initState() {
    ...
    logic.setData(widget.shopModel);
  }
                        ...
                        InkWell(
                          ...
                          child: Container(
                            ...
                            child: _editProfileLogic.downloadURL == null
                                ? _editProfileLogic.shopImage != null
                                    ? ClipRRect(
                                        borderRadius: BorderRadius.circular(10),
                                        child: Image.file(
                                          _editProfileLogic.shopImage!,
                                          fit: BoxFit.cover,
                                        ))
                                    : const Icon(
                                        Icons.add_a_photo,
              ...
              CupertinoDialogAction(
                  ...
                  onPressed: () async {
                    ...
                    shopImagesList.add(await ImagePickerGC.pickImage(
                        ...
                        maxHeight: 600));
                    setState(() {
                      Get.find<EditProfileLogic>().shopImage =
